...
if __name__ == "__main__":
	...
	while source:
		...
		# tune the system if moses_nbest is available and tuning is on
		weights_annotate=""
		if tuning_switch == "on" and decoder_type == "Moses_nbest":
			weights_annotate=Tuning_object.optimize(nbestList, correction)
		...
		if not weights_annotate == "":
			annotated_source += weights_annotate
